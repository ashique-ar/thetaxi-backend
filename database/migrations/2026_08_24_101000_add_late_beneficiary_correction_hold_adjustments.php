...
return new class extends Migration
{
    ...
    public function down(): void
    {
        if (DB::table('sales_commission_hold_adjustments')
            ->where('adjustment_kind', 'late_beneficiary_correction_entitlement')->exists()) {
            throw new RuntimeException('Rollback refused: export and reconcile late beneficiary-correction commission entitlement evidence first.');
        }
