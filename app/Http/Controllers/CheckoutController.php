        ...
        try {
            ...
            $booking = Booking::create([
                ...
                'pickup_location' => json_encode([
                    ...
                    'lat' => $firstItem['from_lat'] ?? null,
                    'lng' => $firstItem['from_lng'] ?? null,
                ]),
                'dropoff_location' => json_encode([
                    'address' => $firstItem['return_location'] ?? $firstItem['pickup_location'] ?? '',
                    'city' => $validated['city'],
                    'country' => $validated['country'],
                    'lat' => $firstItem['return_lat'] ?? $firstItem['from_lat'] ?? null,
                    'lng' => $firstItem['return_lng'] ?? $firstItem['from_lng'] ?? null,
                ]),
