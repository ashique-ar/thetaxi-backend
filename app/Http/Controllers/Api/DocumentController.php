...
class DocumentController extends Controller
{
    ...
    private function payload(Document $document): array
    {
        ...
        return [
            'id' => $document->id,
            'owner_type' => array_search($document->documentable_type, self::OWNER_TYPES, true) ?: $document->documentable_type,
            ...
            'file_url' => $this->storageUrl($document->disk, $document->path),
