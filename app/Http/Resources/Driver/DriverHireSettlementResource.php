...
class DriverHireSettlementResource extends JsonResource
{
    public function toArray($request): array
    {
        return [
            ...
            'cash_collected_unsettled' => (float) ($this->cash_collected_unsettled ?? 0),
            'settlement_due_date'=>$this->settlement_due_date,'payment_reference'=>$this->payment_reference,'settlement_proof_files'=>$this->settlement_proof_files,'settlement_recorded_at'=>$this->settlement_recorded_at,
            'dispute_reason'=>$this->dispute_reason,'disputed_at'=>$this->disputed_at,
            'status' => $this->status,
