...
class DriverHireSettlement extends BaseModel
{
    protected $fillable = [
        ...
        'iou_total',
        'final_balance',
        'cash_collected_unsettled',
        'settlement_due_date','payment_reference','settlement_proof_files','settlement_recorded_at','settlement_recorded_by','dispute_reason','disputed_at','disputed_by',
        'status',
        'submitted_at',
        'ops_reviewed_at',
        'ops_reviewed_by',
    ...
    protected $casts = [
        ...
        'cash_collected_unsettled' => 'decimal:2',
        'settlement_due_date'=>'date','settlement_proof_files'=>'array','settlement_recorded_at'=>'datetime','disputed_at'=>'datetime',
        'night_count' => 'integer',
