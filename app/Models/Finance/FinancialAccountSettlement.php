...
class FinancialAccountSettlement extends BaseModel
{
    ...
    protected $casts = ['period_start'=>'date','period_end'=>'date','due_date'=>'date','issued_at'=>'datetime','settled_at'=>'datetime','statement_sent_at'=>'datetime','statement_sent_to'=>'array','charges_total'=>'decimal:2','payments_total'=>'decimal:2','refunds_total'=>'decimal:2','adjustments_total'=>'decimal:2','outstanding_total'=>'decimal:2','billing_terms_snapshot'=>'array','statement_snapshot'=>'array'];
