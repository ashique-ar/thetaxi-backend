...
/**
 * App\Models\Vehicle\VehicleTransmission
 *
 * @property string $id Primary key (UUID)
 * @property string|null $name Transmission type name (optional)
 * @property string|null $description Transmission type description (optional)
 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Models\Vehicle\Vehicle[] $vehicles Vehicles with this transmission
 */
class VehicleTransmission extends BaseModel
{
    ...
    /**
     * Get all vehicles with this transmission.
     *
