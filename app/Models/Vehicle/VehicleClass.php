...
/**
 * App\Models\Vehicle\VehicleClass
 *
 * @property string $id Primary key (UUID)
 * @property string|null $name Vehicle class name (optional)
 * @property string|null $description Vehicle class description (optional)
 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Models\Vehicle\Vehicle[] $vehicles Vehicles in this class
 */
class VehicleClass extends BaseModel
{
    ...
    /**
     * Get all vehicles in this class.
     *
