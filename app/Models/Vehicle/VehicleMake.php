...
/**
 * App\Models\Vehicle\VehicleMake
 *
 * @property string $id Primary key (UUID)
 * @property string|null $name Vehicle make name (optional)
 * @property string|null $description Vehicle make description (optional)
 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Models\Vehicle\Vehicle[] $vehicles Vehicles of this make
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Models\Vehicle\VehicleModel[] $models Models of this make
 */
