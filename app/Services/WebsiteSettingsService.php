...
class WebsiteSettingsService
{
    ...
    public function getSmsSettings(): array
    {
        $types = [
            ...
            'sms_quotation_requested_enabled',
            'sms_inquiry_received_enabled',
            'sms_driver_dispatched_enabled',
            'sms_driver_arrived_enabled',
            'sms_trip_completion_enabled',
            'sms_payment_confirmation_enabled',
            'sms_trip_completion_scope',
            'sms_driver_assignment_fallback_enabled',
            'sms_driver_assignment_fallback_timeout_minutes',
            'sms_admin_booking_summary_enabled',
