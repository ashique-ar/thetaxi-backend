...
class PricingVariableService
{
    ...
    private function getVariableDescription(string $varName): string
    {
        $descriptions = [
            ...
            'pickup_waiting_charge_per_minute' => 'Pickup waiting charge per minute after the free allowance',
            'hire_waiting_charge_per_minute' => 'In-hire waiting charge per minute',
            'pickup_free_waiting_minutes' => 'Free waiting minutes at pickup',
    ...
    private function getVariableUnit(string $varName): string
    {
        ...
        $units = [
            ...
            'pickup_waiting_charge_per_minute' => "{$currency}/minute",
            'hire_waiting_charge_per_minute' => "{$currency}/minute",
            'pickup_free_waiting_minutes' => 'minutes',
