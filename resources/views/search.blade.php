...
@section('content')
    ...
    <div class="breadcrumb-section three"
        style="background-image:linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(assets/img/innerpages/breadcrumb-bg6.jpg);">
        <div class="container">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="list-grid-product-wrap">
                        <div class="row gy-md-5 gy-4">
                            <div class="col-md-6 item wow animate fadeInDown" data-wow-delay="200ms"
                                data-wow-duration="1500ms">
                                <div class="hotel-card">
                                    <div class="hotel-img-wrap">
                                        <a href="hotel-details.html" class="hotel-img">
                                            <img src="{{ asset('assets/img/innerpages/hotel-img1.jpg') }}" alt="">
                                        </a>
                                        <div class="batch">
                                            <span>Hot Sale!</span>
                                        </div>
                            ...
                            <div class="col-md-6 item wow animate fadeInDown" data-wow-delay="400ms"
                                data-wow-duration="1500ms">
                                <div class="hotel-card">
                                    <div class="hotel-img-wrap">
                                        <a href="hotel-details.html" class="hotel-img">
                                            <img src="{{}}assets/img/innerpages/hotel-img2.jpg')}}"
                                                alt="">
                                        </a>
                                        <div class="batch">
                            ...
                            <div class="col-md-6 item wow animate fadeInDown" data-wow-delay="600ms"
                                data-wow-duration="1500ms">
                                <div class="hotel-card">
                                    <div class="hotel-img-wrap">
                                        <a href="hotel-details.html" class="hotel-img">
                                            <img src="{{}}assets/img/innerpages/hotel-img3.jpg')}}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="hotel-content">
                            ...
                            <div class="col-md-6 item wow animate fadeInDown" data-wow-delay="800ms"
                                data-wow-duration="1500ms">
                                <div class="hotel-card">
                                    <div class="hotel-img-wrap">
                                        <a href="hotel-details.html" class="hotel-img">
                                            <img src="{{}}assets/img/innerpages/hotel-img4.jpg')}}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="hotel-content">
                            ...
                            <div class="col-md-6 item wow animate fadeInDown" data-wow-delay="600ms"
                                ...
                                <div class="hotel-card">
                                    <div class="hotel-img-wrap">
                                        <a href="hotel-details.html" class="hotel-img">
                                            <img src="{{}}assets/img/innerpages/hotel-img5.jpg')}}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="hotel-content">
                            ...
                            <div class="col-md-6 item wow animate fadeInDown" data-wow-delay="400ms"
                                ...
                                <div class="hotel-card">
                                    <div class="hotel-img-wrap">
                                        <a href="hotel-details.html" class="hotel-img">
                                            <img src="{{}}assets/img/innerpages/hotel-img6.jpg')}}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="hotel-content">
                                        ...
                                        <h5><a href="hotel-details.html">Sydell Group Hotels</a></h5>
                                        <div class="location-area">
                                            <div class="location">
                                                <svg width="14" height="14" viewBox="0 0 14 14"
                                                    xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="pagination-area mt-60 wow animate fadeInUp" data-wow-delay="200ms"
                        data-wow-duration="1500ms">
