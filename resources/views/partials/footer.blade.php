    ...
    <div class="container">
        <div class="footer-contact-wrap">
            <div class="inquiry-area">
                ...
                <div class="content">
                    <h6>{{ $settings['footer_inquiry_heading'] ?? 'Need Help Booking?' }}</h6>
                    <span>{{ $settings['footer_inquiry_subheading'] ?? 'Call or message us for quick assistance.' }}</span>
                </div>
            </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="footer-logo-and-addition-info">
                        <a href="{{ route('home') }}" class="footer-logo">
                            <img src="{{ s3_asset($settings['logo_footer'] ?? $settings['logo_header'] ?? 'assets/img/header-logo.png') }}" alt="{{ $settings['logo_footer_alt'] ?? $settings['site_name'] ?? $settings['brand_name'] ?? 'Company' }}">
                        </a>
                        ...
                        <div class="language-area">
                            ...
                            <ul class="language-list">
                                <li><a href="#"><img src="{{ asset('assets/img/home1/england-flag.png') }}" alt="">English</a></li>
                                <li><a href="#"><img src="{{ asset('assets/img/home1/netherlands-flag.png') }}" alt="">Dutch</a></li>
                                <li><a href="#"><img src="{{ asset('assets/img/home1/japan-flag.png') }}" alt="">Japanese</a></li>
                                <li><a href="#"><img src="{{ asset('assets/img/home1/korea-flag.png') }}" alt="">Korean</a></li>
                ...
                <div class="copyright-and-payment-method-area">
                    ...
                    {{-- <div class="payment-method-area">
                        ...
                        <ul>
                            ...
                            <li><img src="{{ asset('assets/img/home1/icon/visa-icon.svg') }}" alt=""></li>
