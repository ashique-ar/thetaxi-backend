    ...
    <div class="travel-inspiration-page pt-100 mb-100">
        <div class="container">
            <div class="row gy-md-5 gy-4 mb-60">
                ...
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="{{ (($index % 3) * 200) + 200 }}ms" data-wow-duration="1500ms">
                    <div class="blog-card2 two">
                        <div class="blog-img-wrap">
                            <a href="{{ route('cms.show', [$contentType->slug, $content->slug]) }}" class="blog-img">
                                <img src="{{ $content->featured_image ?? 'assets/img/home3/blog-img1.jpg' }}" alt="{{ $content->title }}">
                            </a>
                        ...
                        <div class="blog-content">
                            <a href="{{ route('cms.index', $contentType->slug) }}" class="blog-date">{{ $content->published_at ? $content->published_at->format('d F, Y') : $content->created_at->format('d F, Y') }}</a>
                            <h4><a href="{{ route('cms.show', [$contentType->slug, $content->slug]) }}">{{ $content->title }}</a></h4>
