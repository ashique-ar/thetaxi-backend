...
@push('meta')
<meta name="description" content="{{ $contentType->description ?? 'Explore our ' . strtolower($contentType->title) . ' collection at TheTaxi. Find the latest updates and information.' }}">
...
<meta property="og:description" content="{{ $contentType->description ?? 'Explore our ' . strtolower($contentType->title) . ' collection at TheTaxi.' }}">
<meta property="og:type" content="website">
<meta property="og:url" content="{{ request()->url() }}">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="{{ $contentType->title }} - TheTaxi">
<meta name="twitter:description" content="{{ $contentType->description ?? 'Explore our ' . strtolower($contentType->title) . ' collection at TheTaxi.' }}">
@endpush
...
<style>
    ...
    .cms-header::before {
        ...
        right: 0;
        bottom: 0;
        background: url('assets/img/innerpages/breadcrumb-bg2.jpg') center/cover;
        opacity: 0.1;
        z-index: 1;
    }
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12">
                        <div class="search-box">
                            <input type="text" name="search" placeholder="Search {{ strtolower($contentType->title) }}..." 
        ...
        <div class="container">
            <div class="row gy-md-5 gy-4 mb-60">
                @forelse($contents as $index => $content)
                    <div class="col-lg-4 col-md-6 col-sm-12" data-aos="fade-up" data-aos-delay="{{ ($index % 3) * 100 }}">
                        <article class="enhanced-blog-card">
                            ...
                            <div class="card-content">
                                ...
                                <div class="card-footer">
                                    <a href="{{ route('cms.show', [$contentType->slug, $content->slug]) }}" class="read-more">
                                        Read More 
                ...
                @empty
                    <div class="col-12">
                        <div class="no-results">
                            ...
                            <p>
                                @if(request('search'))
                                    No results found for "<strong>{{ request('search') }}</strong>". Try adjusting your search terms.
                                @else
                                    There are currently no published {{ strtolower($contentType->title) }} available.
                                @endif
                            </p>
                            @if(request()->hasAny(['search', 'sort', 'featured']))
                                <a href="{{ route('cms.index', $contentType->slug) }}" class="filter-tag">Clear All Filters</a>
                            @endif
                        </div>
                    </div>
                @endforelse
