                        ...
                        <form action="{{ route('cms.search') }}" method="GET" class="search-form">
                            <div class="row g-3 align-items-end">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="search-query" name="q" placeholder="Search content..." value="{{ $query }}" class="form-control">
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <select id="content-type" name="type" class="form-select">
                                        ...
                                        <option value="{{ $type->slug }}" {{ $contentTypeSlug === $type->slug ? 'selected' : '' }}>
                                            {{ $type->title }}
                                        </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="col-lg-4 col-md-6 wow animate fadeInDown" 
                            ...
                            <div class="blog-card2 two">
                                <div class="blog-img-wrap">
                                    <a href="{{ route('cms.show', [$content->contentType->slug, $content->slug]) }}" class="blog-img">
                                        @if($content->featured_image)
                                            <img src="{{ $content->featured_image }}" alt="{{ $content->title }}">
                                        @else
                                            <img src="assets/img/home3/blog-img1.jpg" alt="{{ $content->title }}">
                                        @endif
                                    </a>
                                ...
                                <div class="blog-content">
                                    ...
                                    <h4><a href="{{ route('cms.show', [$content->contentType->slug, $content->slug]) }}">{{ $content->title }}</a></h4>
                                    @if($content->excerpt)
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <div class="no-results-message py-5">
                            ...
                            <div class="mt-4">
                                @foreach($contentTypes as $type)
                                    <a href="{{ route('cms.index', $type->slug) }}" class="btn btn-outline-primary me-2 mb-2">
                                        {{ $type->title }}
                                    </a>
                                @endforeach
                            </div>
...
@endsection
            ...
            <div class="row mb-30">
                <div class="col-12">
                    <div class="search-results-info">
                        ...
                        @if($contentTypeSlug)
                            in {{ $contentTypes->where('slug', $contentTypeSlug)->first()->title ?? 'Unknown Category' }}
                        @endif
                        </p>
                    </div>
                </div>
            ...
            <div class="row gy-md-5 gy-4 mb-60">
                ...
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="{{ ($loop->index % 3) * 200 + 200 }}ms" data-wow-duration="1500ms">
                    <div class="blog-card2 two">
                        <div class="blog-img-wrap">
                            <a href="{{ route('cms.show', [$content->contentType->slug, $content->slug]) }}" class="blog-img">
                                <img src="{{ $content->featured_image ?? $content->thumbnail ?? 'assets/img/default-blog.jpg' }}" alt="{{ $content->title }}">
                            </a>
                            @if($content->is_featured)
                            <a href="{{ route('cms.index', $content->contentType->slug) }}" class="location">
                                <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M8.994 0L11.092 6.169L18 6.177L12.456 10.254L14.547 16.425L8.994 12.358L3.453 16.425L5.544 10.254L0 6.177L6.908 6.169L8.994 0Z"/>
                                </svg>
                                Featured
                            </a>
                            @else
                    ...
                    <div class="text-center py-5">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="category-links">
                                @foreach($contentTypes as $type)
                                <a href="{{ route('cms.index', $type->slug) }}" class="btn btn-outline-primary btn-sm me-2 mb-2">
                                    @if($type->icon)
                                    <i class="{{ $type->icon }}"></i>
                                    @endif
                                    {{ $type->title }}
            ...
            <div class="pagination-area wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div class="paginations-button">
                    ...
                    <a href="{{ $contents->appends(request()->query())->previousPageUrl() }}">
                        <svg width="10" height="10" viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                            <path d="M8.75 1.25L3.75 5L8.75 8.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                        Prev
                    </a>
                    @endif
                ...
                <div class="paginations-button">
                    ...
                    <a href="{{ $contents->appends(request()->query())->nextPageUrl() }}">
                        Next
                        <svg width="10" height="10" viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                            <path d="M1.25 1.25L6.25 5L1.25 8.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </a>
                    @endif
                </div>
