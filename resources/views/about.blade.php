...
@sec                                  <p>{{ $aboutData['main']['content'] ?? 'TheTaxi Travel Agency is a trusted name in the travel industry, offering seamless travel planning, personalized itineraries, and unforgettable adventures. With years of experience and a network of global partners, we ensure a hassle-free and memorable journey for every traveler.' }}</p>
                                @if(isset($aboutData['main']['description']) && $aboutData['main']['description'])
                                <p>{{ $aboutData['main']['description'] }}</p>
                                @endif                       <h2>{{ $aboutData['main']['title'] ?? "Why We're Best Agency" }}</h2>ion('title', ($aboutData['breadcrumb']['title'] ?? 'About TheTaxi') . ' - Professional Taxi Services')

@section('content')

    <!-- Start Breadcrumb section -->
    <div class="breadcrumb-section"
        style="background-image:linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url({{ asset($aboutData['breadcrumb']['background_image'] ?? 'assets/img/innerpages/breadcrumb-bg2.jpg') }});">
        <div class="container">
            <div class="banner-content">
                <h1>{{ $aboutData['breadcrumb']['title'] ?? 'About TheTaxi' }}</h1>
                <ul class="breadcrumb-list">
                    <li><a href="{{ url('/') }}">{{ $aboutData['breadcrumb']['home_link'] ?? 'Home' }}</a></li>
                    <li>{{ $aboutData['breadcrumb']['current_page'] ?? 'About TheTaxi' }}</li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="about-wrapper">
                <div class="row align-items-center justify-content-between">
                    <div class="col-xl-6 col-lg-7 wow animate fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div class="about-content">
                            <div class="section-title">
                                ...
                                <h4>{{ $aboutData['main']['subtitle'] ?? 'Welcome to TheTaxi Travel Agency – Your Gateway to Unforgettable Journeys!' }}</h4>
                            ...
                            <div class="founder-area">
                                <img src="{{ asset($aboutData['main']['founder_signature'] ?? 'assets/img/innerpages/about-page-founder-signature.png') }}"
                                    alt="Founder Signature">
                                <div class="founder-info">
                                    <h6>{{ $aboutData['main']['founder_name'] ?? 'Robert Harringson' }}</h6>
                                    <span>{{ $aboutData['main']['founder_title'] ?? 'Founder at TheTaxi' }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5 d-lg-block d-none wow animate fadeInRight" data-wow-delay="200ms"
                        ...
                        <div class="about-img">
                            <img src="{{ asset($aboutData['main']['about_image'] ?? 'assets/img/home3/about-img.png') }}" alt="About {{ config('app.name', 'TheTaxi') }}">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="service-wrapper">
                ...
                <div class="bottom-area d-flex justify-content-center wow animate fadeInUp" data-wow-delay="200ms"
                    data-wow-duration="1500ms">
                    <div class="batch">
                        <span>{{ $aboutData['offer']['text'] ?? 'Flat 30% Discounts All Packages' }}</span>
                        <a href="{{ $aboutData['offer']['link_url'] ?? 'travel-package-01.html' }}">{{ $aboutData['offer']['link_text'] ?? 'Check Offer' }}
                                ...
                                <div class="swiper-slide">
                                    <div class="nav-item" role="presentation">
                                        <div class="nav-link active" id="pills-one-tab" data-bs-toggle="pill"
                                            ...
                                            aria-selected="true">
                                            <img src="{{ asset('assets/img/innerpages/about-page-journey-img1.jpg') }}"
                                                alt="">
                                            <h4>1986</h4>
                                        </div>
                                        <span class="dot"></span>
                                ...
                                <div class="swiper-slide">
                                    <div class="nav-item" role="presentation">
                                        <div class="nav-link" id="pills-two-tab" data-bs-toggle="pill"
                                            ...
                                            aria-selected="true">
                                            <img src="{{ asset('assets/img/innerpages/about-page-journey-img2.jpg') }}"
                                                alt="">
                                            <h4>1996</h4>
                                        </div>
                                        <span class="dot"></span>
                                ...
                                <div class="swiper-slide">
                                    <div class="nav-item" role="presentation">
                                        <div class="nav-link" id="pills-three-tab" data-bs-toggle="pill"
                                            ...
                                            aria-selected="true">
                                            <img src="{{ asset('assets/img/innerpages/about-page-journey-img3.jpg') }}"
                                                alt="">
                                            <h4>2006</h4>
                                        </div>
                                        <span class="dot"></span>
                                ...
                                <div class="swiper-slide">
                                    <div class="nav-item" role="presentation">
                                        <div class="nav-link" id="pills-four-tab" data-bs-toggle="pill"
                                            ...
                                            aria-selected="true">
                                            <img src="{{ asset('assets/img/innerpages/about-page-journey-img4.jpg') }}"
                                                alt="">
                                            <h4>2016</h4>
                                        </div>
                                        <span class="dot"></span>
                                ...
                                <div class="swiper-slide">
                                    <div class="nav-item" role="presentation">
                                        <div class="nav-link" id="pills-five-tab" data-bs-toggle="pill"
                                            ...
                                            aria-selected="true">
                                            <img src="{{ asset('assets/img/innerpages/about-page-journey-img5.jpg') }}"
                                                alt="">
                                            <h4>2022</h4>
                                        </div>
                                        <span class="dot"></span>
                                ...
                                <div class="swiper-slide">
                                    <div class="nav-item" role="presentation">
                                        <div class="nav-link" id="pills-six-tab" data-bs-toggle="pill"
                                            ...
                                            aria-selected="true">
                                            <img src="{{ asset('assets/img/innerpages/about-page-journey-img6.jpg') }}"
                                                alt="">
                                            <h4>2023</h4>
                                        </div>
                                        <span class="dot"></span>
                                ...
                                <div class="swiper-slide">
                                    <div class="nav-item" role="presentation">
                                        <div class="nav-link" id="pills-seven-tab" data-bs-toggle="pill"
                                            ...
                                            aria-selected="true">
                                            <img src="{{ asset('assets/img/innerpages/about-page-journey-img7.jpg') }}"
                                                alt="">
                                            <h4>2025</h4>
                                        </div>
                                        <span class="dot"></span>
