    ...
    <div class="container">
        <div class="header">
            <img src="{{ asset('assets/img/header-logo.png') }}" alt="TheTaxi"
                style="max-height: 44px; margin-bottom: 10px;">
            <h1>
        ...
        <div class="content">
            <p style="font-size: 16px;">Dear <strong>{{ $booking->customer->full_name ?? 'Valued Customer' }}</strong>,
            </p>

            <p>
                @if ($booking->payment_status === 'paid')
                    Thank you for your booking with TheTaxi! Your reservation has been confirmed and we're excited to
                    serve you.
                @elseif($booking->status === 'quotation_requested')
                ...
                <table class="info-table">
                    @if (!empty($cartItems))
                        @foreach ($cartItems as $item)
                            ...
                            <tr>
                                <td>Subtotal</td>
                                <td>{{ $currencySymbol }}{{ number_format(($item['price'] ?? 0) * ($item['days'] ?? 1), 2) }}
                                </td>
                            </tr>
                        @endforeach
                    @else
            ...
            <div class="section">
                ...
                <table class="info-table">
                    ...
                    <tr style="border-top: 2px solid #c91c23;">
                        ...
                        <td style="font-size: 18px; color: #c91c23;">
                            <strong>{{ $currencySymbol }}{{ number_format($booking->total_estimated, 2) }}</strong>
                        </td>
                    </tr>
                    @if ($booking->payment_type === 'advance')
                        ...
                        <tr style="background: #e8f4f8;">
                            ...
                            <td>{{ $currencySymbol }}{{ number_format($booking->total_estimated - ($booking->amount_to_pay ?? 0), 2) }}
                            </td>
                        </tr>
                    @elseif($booking->payment_status === 'paid')
                        <tr style="background: #d4edda;">
                            <td><strong>Amount Paid</strong></td>
                            <td><strong>{{ $currencySymbol }}{{ number_format($booking->amount_to_pay ?? $booking->total_estimated, 2) }}</strong>
                            </td>
                        </tr>
                    @endif
                    <tr>
            ...
            <div class="section">
                ...
                @if ($booking->status === 'quotation_requested')
                    <div class="highlight-box">
                        ...
                        <p><strong>✅ Step 3:</strong> You'll receive a detailed quote with vehicle options and pricing
                        </p>
                        <p style="margin-bottom: 0;"><strong>✅ Step 4:</strong> Once approved, we'll send a secure
                    ...
                    <div class="highlight-box" style="border-left-color: #ffc107;">
                        ...
                        <table style="width: 100%; margin: 15px 0;">
                            <tr>
                                ...
                                <td>Casons Rent A Car (Pvt) Ltd</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="padding: 5px 0;"><strong>Account No:</strong></td>
                                <td>1234567890</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="padding: 5px 0;"><strong>SWIFT Code:</strong></td>
                                <td>CCEYLKLX</td>
                            </tr>
                            <tr>
                                <td style="padding: 5px 0;"><strong>Reference:</strong></td>
                                <td style="color: #c91c23; font-weight: bold;">{{ $booking->booking_number }}</td>
                            </tr>
                        </table>
                        <p style="margin-bottom: 0;">After payment, please email the receipt to: <a
                                href="mailto:payments@casonsrentacar.lk">payments@casonsrentacar.lk</a></p>
                        <p style="margin-bottom: 0;"><em>Our team will verify your payment within 2-4 business hours and
                                send final confirmation.</em></p>
                    </div>
            ...
            <div class="section">
                ...
                <table class="info-table">
                    ...
                    <tr>
                        <td>📧 Email</td>
                        <td><a
                                href="mailto:{{ config('mail.from.address', 'bookings@thetaxi.com') }}">{{ config('mail.from.address', 'bookings@thetaxi.com') }}</a>
                        </td>
                    </tr>
                    <tr>
                        <td>🌐 Website</td>
                ...
                <p style="text-align: center; margin-top: 20px;">Our customer support team is available 24/7 to assist
                    you.</p>
            </div>
