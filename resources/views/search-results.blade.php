            ...
            @if(isset($results['data']) && count($results['data']) > 0)
                ...
                <div class="row g-4 vehicle-results-grid">
                    @foreach($results['data'] as $result)
                        ...
                        <!-- Vehicle Card -->
                        <div class="col-lg-3 col-md-4 col-sm-12" data-vehicle-group="{{ $result['id'] }}" data-price="{{ $pricing['base_amount'] ?? 0 }}" data-name="{{ $result['name'] ?? 'Unknown Vehicle' }}">
                            <div class="vehicle-card modern-card h-100 {{ $isRecommended ? 'recommended-vehicle' : '' }}">
                                <!-- Vehicle Image -->
                                <div class="vehicle-image-container">
                                    <img src="{{ $mainImage }}" alt="{{ $result['name'] ?? 'Unknown Vehicle' }}" class="vehicle-img">
                                ...
                                <div class="vehicle-card-content">
                                    <!-- Vehicle Name -->
                                    <h5 class="vehicle-name">{{ $result['name'] ?? 'Unknown Vehicle' }}</h5>
                                    ...
                                    <div class="vehicle-specs">
                                        @if(isset($result['seating_capacity']))
                                        <div class="spec-item">
                                            <i class="bi bi-people-fill"></i>
                                            <span>{{ $result['seating_capacity'] }} Seats</span>
                                        </div>
                                        @endif
                                        
                                        @if(isset($result['transmission']['name']))
                                        <div class="spec-item">
                                            <i class="bi bi-gear-fill"></i>
                                            <span>{{ $result['transmission']['name'] }}</span>
                                        </div>
                                        @endif
                                        
                                        @if(isset($result['fuel_type']['name']))
                                        <div class="spec-item">
                                            <i class="bi bi-fuel-pump-fill"></i>
                                            <span>{{ $result['fuel_type']['name'] }}</span>
                                        </div>
                                        @endif
                                    ...
                                    <div class="vehicle-actions mt-3">
                                        ...
                                        @if($availability['available'] > 0)
                                            <button type="button" 
                                                    ...
                                                    data-group-id="{{ $result['id'] }}"
                                                    data-search-id="{{ $search->id }}"
                                                    data-group-name="{{ $result['name'] ?? 'Vehicle' }}"
...
<style>
    ...
    .vehicle-card[data-service="rental-packages"] .category-badge {
