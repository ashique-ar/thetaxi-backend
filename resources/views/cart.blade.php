                                ...
                                <tbody>
                                    @foreach ($cart as $key => $item)
                                        <tr data-cart-key="{{ $key }}">
                                            <td data-label="Vehicle Info">
                                                <div class="product-info-wrapper">
                                                    ...
                                                    <div class="product-info-content">
                                                        ...
                                                        <p><span>Vehicle Type: </span>{{ $item['vehicle_type'] ?? 'Sedan' }}
                                                        </p>
                                                        <div class="booking-details">
                                                            @if (isset($item['pickup_date']) && isset($item['return_date']))
                                                                <p><strong>Pickup:</strong>
                                                                    {{ date('M d, Y', strtotime($item['pickup_date'])) }}
                                                                ...
                                                                <p><strong>Return:</strong>
                                                                    {{ date('M d, Y', strtotime($item['return_date'])) }}
                                                            ...
                                                            @if (isset($item['pickup_location']))
                                                                <p><strong>From:</strong> {{ $item['pickup_location'] }}
                                                                </p>
                                                            @endif
                                            ...
                                            <td data-label="Total">
                                                <span
                                                    class="item-total">{{ $currencySymbol }}{{ number_format(($item['price'] ?? 0) * ($item['days'] ?? 1), 2) }}</span>
                                            </td>
