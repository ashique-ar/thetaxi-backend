...
@php
    ...
    $isSpecialOffer = $item->special_offer ?? false;
    $discount = $item->discount_percentage ?? 0;
    
    // Generate detail link based on type and slug
    $detailLink = $item->slug ? route('cms.show', ['contentType' => $type, 'content' => $item->slug]) : '#';
