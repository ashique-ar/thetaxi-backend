...
<body class="tt-magic-cursor">
    ...
    @php
        $waNumber = preg_replace('/[^0-9]/', '', $settings['company_whatsapp'] ?? $settings['company_phone'] ?? '');
    @endphp
    @if($waNumber)
    <!-- WhatsApp Floating Button -->
    <a href="https://wa.me/{{ $waNumber }}" target="_blank" rel="noopener noreferrer" class="whatsapp-float" aria-label="Chat on WhatsApp">
