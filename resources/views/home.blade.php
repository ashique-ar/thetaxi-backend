                                    ...
                                    <div class="custom-select-wrap">
                                        ...
                                        <ul class="option-list visa-list">
                                            <li>
                                                ...
                                                <div class="flag">
                                                    <img src="{{ asset('assets/img/home1/filter-bd-flag.png')}}" alt="">
                                                </div>
                                            </li>
                                            <li>
                                                <div class="destination">
                                                ...
                                                <div class="flag">
                                                    <img src="{{ asset('assets/img/home1/filter-indo-flag.png')}}" alt="">
                                                </div>
                                            </li>
                                            <li>
                                                <div class="destination">
                                                ...
                                                <div class="flag">
                                                    <img src="{{ asset('assets/img/home1/filter-nepal-flag.png')}}" alt="">
                                                </div>
                                            </li>
                                            <li>
                                                <div class="destination">
                                                ...
                                                <div class="flag">
                                                    <img src="{{ asset('assets/img/home1/filter-india-flag.png')}}" alt="">
                                                </div>
                                            </li>
                                            <li>
                                                <div class="destination">
                                                ...
                                                <div class="flag">
                                                    <img src="{{ asset('assets/img/home1/filter-brazil-flag.png')}}" alt="">
                                                </div>
                                            </li>
                                            <li>
                                                <div class="destination">
                                                ...
                                                <div class="flag">
                                                    <img src="{{ asset('assets/img/home1/filter-thailand-flag.png')}}" alt="">
                                                </div>
                                            </li>
                                            <li>
                                                <div class="destination">
                                                ...
                                                <div class="flag">
                                                    <img src="{{ asset('assets/img/home1/filter-spain-flag.png')}}" alt="">
                                                </div>
                                            </li>
                                            <li>
                                                <div class="destination">
                                                ...
                                                <div class="flag">
                                                    <img src="{{ asset('assets/img/home1/filter-uae-flag.png')}}" alt="">
                                                </div>
                                            </li>
                                            <li>
                                                <div class="destination">
                                                ...
                                                <div class="flag">
                                                    <img src="{{ asset('assets/img/home1/filter-usa-flag.png')}}" alt="">
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
