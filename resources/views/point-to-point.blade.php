                        ...
                        <div class="filter-input-wrap">
                            ...
                            <form id="point_to_point-form" class="filter-input show" data-service="point_to_point"
                                ...
                                <div class="single-search-box date-field">
                                    <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M14 2h-1V1a1 1 0 0 0-2 0v1H7V1a1 1 0 0 0-2 0v1H4a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2zM4 4h1v1a1 1 0 0 0 2 0V4h4v1a1 1 0 0 0 2 0V4h1v2H4V4zm0 4h10v6H4V8z"/>
                                    </svg>
                                ...
                                <div class="single-search-box">
                                    <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9 0C4.037 0 0 4.037 0 9s4.037 9 9 9 9-4.037 9-9S13.963 0 9 0zm4.5 9.75h-4.5a.75.75 0 0 1-.75-.75V4.5a.75.75 0 0 1 1.5 0v3.75h3.75a.75.75 0 0 1 0 1.5z"/>
                                    </svg>
                                    <div class="custom-select-dropdown">
                                        <select name="time" class="nice-select @error('time') is-invalid @enderror" required>
                                ...
                                <div id="return-transfer-fields" style="display: {{ old('need_return') ? 'block' : 'none' }};">
                                    ...
                                    <div class="single-search-box">
                                        ...
                                        <div class="custom-select-dropdown">
                                            <select name="return_time" class="nice-select @error('return_time') is-invalid @enderror">
                                ...
                                <div class="single-search-box">
                                    ...
                                    <div class="custom-select-dropdown">
                                        <select name="passengers" class="nice-select @error('passengers') is-invalid @enderror" required>
            ...
            <div class="row">
                <div class="col-lg-6 wow animate fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="package-content-wrap">
                        ...
                        <p class="mb-4">Our point-to-point transfer service provides reliable transportation between any two locations. Whether you need to get to work, attend appointments, or travel for leisure, we've got you covered.</p>
                ...
                <div class="col-lg-6 wow animate fadeInRight" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="package-img-area">
                        <img src="{{ asset('assets/img/home4/package-img.jpg')}}" alt="Point-to-Point Service" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-8 mx-auto">
                    ...
                    <div class="accordion" id="pointToPointFAQ">
                        <div class="accordion-item">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#pointToPointFAQ">
                                <div class="accordion-body">
                                    You can book your point-to-point transfer up to 30 days in advance. For immediate rides, we accept bookings as little as 30 minutes before pickup time, subject to vehicle availability.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#pointToPointFAQ">
                                <div class="accordion-body">
                                    Yes, you can add stops during your journey. Please specify additional stops when booking, as this may affect the pricing and travel time.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#pointToPointFAQ">
                                <div class="accordion-body">
                                    We understand plans can change. You can modify or cancel your booking up to 2 hours before the scheduled pickup time without any charges. Changes within 2 hours may incur additional fees.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#pointToPointFAQ">
                                <div class="accordion-body">
                                    Yes, we offer discounted rates for return journeys when booked together. The return trip discount can be up to 15% off the regular fare.
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            $('.custom-datepicker[name="return_date"]').on('change', function() {
                ...
                if (pickupDate && returnDate && isValidDDMMYYYY(pickupDate) && isValidDDMMYYYY(returnDate)) {
                    ...
                    if (returnD < pickup) {
                        $(this).addClass('is-invalid');
                        $(this).siblings('.invalid-feedback').remove();
                        $(this).after('<div class="invalid-feedback">Return date must be on or after pickup date</div>');
                    } else {
                        $(this).removeClass('is-invalid');
                        $(this).siblings('.invalid-feedback').remove();
                    }
