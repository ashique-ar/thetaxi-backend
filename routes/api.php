...
Route::middleware(['auth:api'])->group(function () {
    ...
    */
    ...
    Route::middleware(['permission:bookings.view'])->group(function () {
        ...
        Route::prefix('financial-settlements')->middleware('booking.operations.telemetry')->group(function () {
            ...
            Route::get('adjustments/{adjustment}/document', [FinancialSettlementController::class, 'downloadAdjustment'])->whereUuid('adjustment')->middleware('permission:financial-settlements.view');
            Route::get('{financialSettlement}', [FinancialSettlementController::class, 'show'])->middleware('permission:financial-settlements.view');
            Route::post('corporates/{corporate}/remittances', [FinancialSettlementController::class, 'receiveCorporateRemittance'])->whereUuid('corporate')->middleware('permission:financial-settlements.receive|financial-settlements.manage');
            Route::post('corporate-remittances/{remittance}/allocate', [FinancialSettlementController::class, 'allocateCorporateRemittance'])->whereUuid('remittance')->middleware('permission:financial-settlements.allocate|financial-settlements.manage');
            Route::post('corporate-remittance-allocations/{allocation}/reverse', [FinancialSettlementController::class, 'reverseCorporateRemittanceAllocation'])->whereUuid('allocation')->middleware('permission:financial-settlements.allocate|financial-settlements.manage');
            Route::post('', [FinancialSettlementController::class, 'store'])->middleware('permission:financial-settlements.manage');
            Route::post('{financialSettlement}/issue', [FinancialSettlementController::class, 'issue'])->middleware('permission:financial-settlements.issue|financial-settlements.manage');
            Route::post('{financialSettlement}/payments', [FinancialSettlementController::class, 'receivePayment'])->middleware('permission:financial-settlements.receive|financial-settlements.manage');
            Route::patch('{financialSettlement}/follow-up', [FinancialSettlementController::class, 'followUp'])->middleware('permission:financial-settlements.follow-up|financial-settlements.manage');
            Route::post('{financialSettlement}/adjustments', [FinancialSettlementController::class, 'adjust'])->middleware('permission:financial-settlements.adjust|financial-settlements.manage');
            Route::post('{financialSettlement}/dispute', [FinancialSettlementController::class, 'dispute'])->middleware('permission:financial-settlements.dispute|financial-settlements.manage');
            Route::post('{financialSettlement}/resolve-dispute', [FinancialSettlementController::class, 'resolveDispute'])->middleware('permission:financial-settlements.dispute|financial-settlements.manage');
    ...
    */
    ...
    Route::prefix('corporate')->middleware(['ensure.corporate'])->group(function () {
        ...
        Route::get('booking-employees', [\App\Http\Controllers\Api\Corporate\CorporateBookingController::class, 'bookingEmployees']);
